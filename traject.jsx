          ...
          <div>
            ...
            <div className="ewk-trj-signals">
              {["Je hoofd staat altijd aan.", "Je energie raakt langzaam op.", "Je verliest het overzicht.",
                ...
                <span key={s}><Icon name="minus" />{s}</span>
              ))}
            </div>
            <p className="ewk-hero__lead" style={{ marginTop: 22 }}>
          ...
          <div className="ewk-oplevert">
            ...
            <div className="ewk-oplevert__row">
              ...
              <div className="ewk-oplevert__block">
                ...
                <p>Je vindt jezelf weer terug. Je begrijpt waarom je vastliep en leert hoe je perfectionisme, verantwoordelijkheidsgevoel en altijd maar doorgaan duurzaam doorbreekt.</p>
              </div>
            </div>
          </div>
      ...
      <section className="ewk-section ewk-section--sand">
        <div className="ewk-wrap">
          ...
          <div className="ewk-tsteps">
            {TRJ_STAPPEN.map(([t, d], i) => (
              <div className="ewk-tstep" key={t}>
