    ...
    <section className="ewk-hero ewk-hero--quote">
      <div className="ewk-wrap ewk-hero__grid">
        <div>
          ...
          <p className="ewk-hero__lead" style={{ marginTop: 16 }}>Met een heldere aanpak gericht op jouw brein, lichaam en patronen ontdek je wat je kunt doen om uit die overdrive te komen, zodat je weer keuzes maakt die echt bij je passen.
  ...
  return (
    <section className="ewk-section ewk-section--wash">
      <div className="ewk-wrap ewk-prose" style={{ margin: "0 auto" }}>
        ...
        <p>
          Dat geeft op de korte termijn het gevoel dat je controle houdt. Maar ondertussen neem je steeds minder echte rust, blijf je vooral in je hoofd zitten en raak je verder verwijderd van wat je nodig hebt. Waardoor dat gevoel van onrust, vermoeidheid en een vol hoofd juist blijft. 

          <span className="ewk-key">En dat is precies wat het zo frustrerend maakt. Je doet zó je best, maar het levert niet meer op wat het vroeger deed.
          </span>
        </p>
        <p>
  ...
  return (
    <section className="ewk-section">
      <div className="ewk-wrap">
        ...
        <p className="ewk-section__sub ewk-section__sub--after">Ook al blijft jouw omgeving hetzelfde, jij leert anders omgaan met wat er speelt op een manier die voor jou werkt.</p>
      </div>
    </section>);
    ...
    <section className="ewk-section ewk-section--wash">
      <div className="ewk-wrap ewk-about">
        ...
        <div className="ewk-about__text">
          ...
          <p>Ik ben Agathe, psycholoog en moeder, en ik help al meer dan 10 jaar hoogopgeleide moeders die vastlopen in de combinatie van werk en gezin. Na mijn zwangerschapsverlof ging ik parttime werken, maar mijn taken bleven gelijk. Ik bleef doorgaan, tot mijn lichaam op de rem trapte.



          </p>
          <p>
            Tijdens mijn herstel begon ik te begrijpen wat er werkelijk speelde: een groot verantwoodelijkheidsgevoel, altijd doorgaan en het gevoel dat het nooit genoegd was. Dit zelfde patroon zag ik later steeds terugzag bij de vrouwen die ik begeleid. Ik combineer psychologie, wetenschappelijke inzichten en lichaamsgerichte technieken met 

            <span className="ewk-key">praktische
            stappen die direct toepasbaar zijn</span>. Zodat dat je niet alleen begrijpt wat er met je gebeurt maar ook weet wat je kunt doen om weer rust, energie en regie te ervaren.
          </p>
  ...
  return (
    <div className="ewk-ladder">
      <button className="ewk-rung ewk-rung--sky" onClick={onScan}>
        ...
        <p>Ontdek in 10 minuten wat er écht speelt in jouw brein en lichaam. En wat je nu al kunt doen.</p>
