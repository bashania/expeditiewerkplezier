      ...
      <section className="ewk-section">
        <div className="ewk-wrap ewk-about">
          ...
          <div className="ewk-about__text">
            ...
            <p>
              Niet omdat ze de vaardigheden niet hebben, maar omdat ze niet goed weten waar ze moeten beginnen. Ze blijven nadenken en twijfelen, of proberen van alles tegelijk, waardoor het overzicht juist weer verdwijnt. 

              <span className="ewk-key">Als je eerlijk bent, herken je dat
