...
"Ik help je patronen herkennen die onder je stress liggen: zoals perfectionisme, pleasegedrag, gewoon doorgaan en een groot verantwoordelijkheidsgevoel. Herkennen is de eerste stap. Daarna verkennen we samen wat er voor jou mogelijk is – opties die je zelf niet zo snel had bedacht."],
...
"Je krijgt niet alleen helderheid, maar ook concrete handvatten om weer grip te krijgen op je energie en je leven. We maken het samen glashelder en we sluiten af met een duidelijk plan van aanpak met concrete acties, voor nu en voor de toekomst."]];
...
"een gezonde balans ervaren tussen een uitdagende baan en een fijn gezinsleven",
"je eigen verlangens en grenzen haarscherp in beeld krijgen en ernaar handelen",
"meer rust, ontspanning en oprechte flow ervaren in plaats van constante druk"];
    ...
    <main>
      ...
      <section className="ewk-section ewk-section--sand">
        <div className="ewk-wrap">
          ...
          <p className="ewk-list-note" style={{ marginTop: 40 }}>“Ik ben blijer, energieker en meer gefocust en dat straalt direct door naar mijn gezin. WIN-WIN-WIN!”
      ...
      <section className="ewk-finalcta ewk-finalcta--scan">
        <div className="ewk-wrap ewk-finalcta__inner">
          ...
          <p>Veel vrouwen wachten te lang. Ze denken: “Het gaat vanzelf wel weer over” of “ik moet gewoon even doorzetten.” Maar uitputting verdwijnt zelden van zelf. Het begint met het herkennen van de signalen. Daarom maakte ik een scan met signalen die vaak voorafgaan aan overbelasting of een burn-out.
